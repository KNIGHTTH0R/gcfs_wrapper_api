  ...
  module Wrapper
    module Api
      ...
      class Order < Base
        ...
        QUERY_ATTRIBUTES = [:start_date, :end_date, :client, :client_ids, :contain_delivery_notes, :recepient, :category, :item, :variant, :invoice_number, :transaction_id, :status, :payment_status, :requester, :requester_id, :merchant_id].freeze
